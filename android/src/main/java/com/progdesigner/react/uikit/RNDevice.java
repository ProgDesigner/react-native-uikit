...
public class RNDevice extends ReactContextBaseJavaModule {

  ReactApplicationContext reactContext;

  public RNDevice(ReactApplicationContext reactContext) {
    super(reactContext);
  ...
  public @Nullable Map<String, Object> getConstants() {
    ...
    constants.put("sdkVersion", Build.VERSION.SDK_INT);
